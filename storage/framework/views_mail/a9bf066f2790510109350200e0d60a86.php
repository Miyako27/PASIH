...
<header class="sticky top-0 z-10 bg-white/90 backdrop-blur border-b border-slate-200">
  <div class="px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
    <div class="min-w-0 flex items-center gap-2 sm:gap-3">
      ...
      <div class="min-w-0">
        <div class="truncate text-sm sm:text-base lg:text-lg font-bold tracking-tight"><?php echo e($displayRole); ?></div>
    ...
    <div class="flex items-center gap-2 sm:gap-4">
      ...
      >
        ...
        <?php if($notificationCount > 0): ?>
          <span class="absolute -right-1 -top-1 inline-flex h-4 min-w-4 items-center justify-center rounded-full bg-[#C4132D] px-1 text-[10px] font-bold text-white"><?php echo e($notificationCount); ?></span>
        <?php endif; ?>
      </a>
      ...
      <div class="relative" data-profile-menu>
        ...
        >
          <div class="rounded-xl bg-slate-50 px-4 py-3">
            <div class="truncate text-base font-bold text-slate-800"><?php echo e($displayName); ?></div>
            <div class="mt-0.5 truncate text-sm text-slate-500"><?php echo e($displayInstitution); ?></div>
          </div>
...
<?php if (! $__env->hasRenderedOnce('2e7d6f0d-4f0a-4b4d-b4fe-5be1cdf9384e')): $__env->markAsRenderedOnce('2e7d6f0d-4f0a-4b4d-b4fe-5be1cdf9384e'); ?>
  ...
  <?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH C:\laragon\www\PASIH\resources\views/components/admin/topbar.blade.php ENDPATH**/ ?>