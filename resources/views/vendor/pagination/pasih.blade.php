            ...
            @foreach ($elements as $element)
                @if (is_string($element))
                    <li aria-disabled="true">
                        <span class="inline-flex h-10 min-w-10 items-center justify-center border-l border-slate-300 px-2 text-slate-400">{{ $element }}</span>
                    </li>
                @endif
                    ...
                    @foreach ($element as $page => $url)
                        @if ($page == $paginator->currentPage())
                            <li aria-current="page">
                                <span class="inline-flex h-10 min-w-10 items-center justify-center border-l border-slate-300 bg-slate-100 px-3 font-semibold text-slate-700">{{ $page }}</span>
                            </li>
                        @else
                            <li>
                                <a
