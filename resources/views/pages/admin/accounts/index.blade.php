...
@section('content')
  <div class="space-y-5">
    ...
    <div class="flex items-start justify-between gap-4">
      ...
      <a href="{{ route('admin.accounts.create') }}" class="pasih-add-btn inline-flex items-center gap-2 h-11 px-4 rounded-xl bg-blue-950 text-white text-sm font-semibold hover:bg-blue-900">
    ...
    <div class="rounded-xl bg-white ring-1 ring-slate-200 overflow-hidden">
      ...
      <div class="px-4 py-3 border-t border-slate-200 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 text-sm text-slate-600">
        ...
        <div>
          {{ $accounts->onEachSide(1)->links('vendor.pagination.pasih') }}
        </div>
      </div>
    </div>
  </div>
