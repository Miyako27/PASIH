  ...
  <div class="space-y-5">
    ...
    <div class="flex items-start justify-between gap-4">
      <div>
        ...
        <p class="mt-2 text-sm text-slate-500">Manajemen Instansi</p>
      </div>
              ...
              <tr class="border-t border-slate-100 text-slate-700">
                ...
                <td class="px-4 py-3">
                  <div class="flex items-center gap-1.5">
                    ...
                    <form method="POST" action="{{ route('admin.instansi.destroy', $institution) }}" onsubmit="return confirm('Yakin ingin menghapus data instansi ini?')">
                      @csrf
                      @method('DELETE')
