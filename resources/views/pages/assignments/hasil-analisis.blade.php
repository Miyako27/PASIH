              ...
              <tr class="border-t border-slate-100 text-slate-700">
                ...
                <td class="px-4 py-3">
                  <div class="flex items-center gap-1.5">
                    <a href="{{ route('submissions.show', $item->submission) }}" class="h-8 w-8 rounded-md bg-blue-600 text-white inline-flex items-center justify-center" title="Detail">
                    ...
                    @if(auth()->user()->role->value === 'analis_hukum' && $item->analyst_id === auth()->id())
                      <a href="{{ route('assignments.upload-hasil.form', $item) }}" class="h-8 w-8 rounded-md bg-amber-400 text-white inline-flex items-center justify-center" title="Edit Hasil">
