...
class LogUserActivity
{
    ...
    private function resolveAction(string $routeName, string $method): array
    {
        return match ($routeName) {
            ...
            'assignments.assign-pic.form' => ['type' => 'Penugasan', 'title' => 'Membuka form penentuan PIC', 'detail' => 'Mengakses form untuk menentukan PIC analis.'],
            'assignments.assign-pic.store' => ['type' => 'Penugasan', 'title' => 'Menentukan PIC penugasan', 'detail' => 'Menyimpan PIC analis untuk penugasan.'],
            'assignments.approval.form' => ['type' => 'Penugasan', 'title' => 'Membuka form ACC penugasan', 'detail' => 'Mengakses form ACC atau revisi hasil analisis.'],
            'assignments.approval.store' => ['type' => 'Penugasan', 'title' => 'Menyimpan keputusan ACC penugasan', 'detail' => 'Menyimpan keputusan ACC atau revisi penugasan.'],
